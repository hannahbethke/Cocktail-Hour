// SEARCH BY COCKTAIL NAME:
    ...
    const closeDrinkModal1 = document.querySelector("#closeDrinkModal");
    const recipeModal = document.querySelector("#recipeModal");
    const recipeSection = document.querySelector("#recipeSection");
    const closeRecipeModal1 = document.querySelector("#closeRecipeModal");
    ...
    closeDrinkModal1.addEventListener("click", closeDrinkModal);
    closeRecipeModal1.addEventListener("click", closeRecipeModal);
